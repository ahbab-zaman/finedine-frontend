...
const getIngredientIcon = (ingredient) => {
  ...
  const icons = {
    tomato: "https://www.svgrepo.com/download/489691.svg",
    lemon: "https://www.svgrepo.com/download/505210.svg",
                  ...
                  <div className="flex-1 space-y-3 sm:space-y-4 min-w-0">
                    ...
                    {ingredientsList.length > 0 && (
                      <div className="flex flex-wrap gap-1">
                        {ingredientsList.slice(0, 5).map((ing, idx) => (
                          <span
                            key={idx}
                            className="relative inline-block p-1 rounded bg-gray-100"
                          >
                            <img
